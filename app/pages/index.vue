...
<script setup lang="ts">
  ...
  // );
  import { type RecipieResponse } from "~~/types/types";
  const { data, error } = await useFetch<RecipieResponse>("https://dummyjson.com/recipes?limit=12");
</script>
